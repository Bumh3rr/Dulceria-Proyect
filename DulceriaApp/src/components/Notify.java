...
public class Notify {
    ...
    public void showToast(raven.modal.Toast.Type type, String text) {
        Toast.show(contexto, type, text, getSelectedOption());
    }

    public void showToast(raven.modal.Toast.Type type, JPanel x, String text) {
        Toast.show(x, type, text, getSelectedOption());
    }

    public ToastOption getSelectedOption() {
