...
//                    + "\nCausa: " + e.getLocalizedMessage());
    ...
    public static String[] obtenerMunicipiosPorEstado(String searchEstado) throws Exception {
        String[] estados = null;
        @Cleanup
        InputStream resourceAsStream = EstadosMx.class.getClassLoader().getResourceAsStream("resources/estados-municipios.json");
    ...
    public static HashMap<String, String> obtenerEstados() {
        try {
            @Cleanup
            InputStream resourceAsStream = EstadosMx.class.getClassLoader().getResourceAsStream("resources/estados.json");
